...
// Notes on JavaScript division operations and special values

// 1. Dividing a non-zero number by zero results in Infinity
console.log(10 / 0); // Output: Infinity

// 2. Dividing zero by a non-zero number results in 0
console.log(0 / 10); // Output: 0

// 3. Dividing 0 by null (null is coerced to 0, so 0/0 is NaN)
console.log(0 / null); // Output: NaN

// 4. Dividing 0 by undefined results in NaN
console.log(0 / undefined); // Output: NaN

// 5. Dividing a non-zero number by undefined results in NaN
console.log(10 / undefined); // Output: NaN

// 6. Dividing a non-zero number by null (null is coerced to 0, so 10/0 is Infinity)
console.log(10 / null); // Output: Infinity

// 7. Positive zero (+0) is just 0
console.log(+0); // Output: 0

// 8. Negative zero (-0) is treated as 0 in console output
console.log(-0); // Output: 0

// 9. NaN represents "Not a Number" for invalid math operations
console.log(NaN); // Output: NaN

// 10. Infinity represents mathematical infinity
console.log(Infinity); // Output: Infinity

// 11. -Infinity represents negative infinity
console.log(-Infinity); // Output: -Infinity